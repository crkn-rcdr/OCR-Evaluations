...
Directory-to-directory Excel usage:
  ...
  python tools/compare_multi_document_ocr_errors.py \
    --paddle-dir test-data/preprocessing-tiling_3x1_dp+paddleocr+vl+clean \
...
DEFAULT_PADDLE = (
    REPO_ROOT
    / "test-data/preprocessing-tiling_3x1_dp+paddleocr+vl+clean/oocihm.N_00155_18750610/"
...
DEFAULT_PADDLE_DIR = REPO_ROOT / "test-data/preprocessing-tiling_3x1_dp+paddleocr+vl+clean"
