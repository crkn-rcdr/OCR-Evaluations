...
def build_dashboard_html(
    ...
    paddle_vs_abbyy_display = format_repo_relative(paddle_vs_abbyy_path)
    first_article_display = format_repo_relative(first_article_path)
    ...
    return "\n".join(
        [
            ...
            f"<p><strong>{html.escape(t('en', 'inputs'))}:</strong> <code>{html.escape(paddle_vs_abbyy_display)}</code><br>"
            f"<code>{html.escape(first_article_display)}</code></p>",
            "</header>",
