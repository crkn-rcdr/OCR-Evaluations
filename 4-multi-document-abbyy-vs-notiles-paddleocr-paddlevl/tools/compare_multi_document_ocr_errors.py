...
Default usage, using the paired ABBYY and no-tiling Paddle dataset in this repo:
...
Directory-to-directory Excel usage:
  ...
  python tools/compare_multi_document_ocr_errors.py \
    --paddle-dir test-data/preprocess-notiles-paddleocr-paddlevl \
...
DEFAULT_PADDLE = (
    REPO_ROOT
    / "test-data/preprocess-notiles-paddleocr-paddlevl/oocihm.N_00155_18750610/"
...
DEFAULT_PADDLE_DIR = REPO_ROOT / "test-data/preprocess-notiles-paddleocr-paddlevl"
